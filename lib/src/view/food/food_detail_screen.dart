...
class _FoodDetailScreenState extends StateMVC<FoodDetailScreen>
  ...
  void initState() {
    ...
    if (widget._isCartItem) {
      _controller.listenForCart(foodId: widget.foodId);
    } else {
      _controller.listenForFood(foodId: widget.foodId);
    }
  }
                                  ...
                                  child: ListView(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          InkWell(
                                            onTap: _controller.decreaseQuantity,
                                            child: ClipOval(
                                              child: Material(
                                          ...
                                          SizedBox(
                                              width:
                                                  _appConfig.horizontalSpace()),
                                          InkWell(
                                            onTap: _controller.increaseQuantity,
                                            child: ClipOval(
                                              child: Material(
                                                color: secondaryColor,
                                                child: SizedBox(
                                      ...
                                      TabBarNoRipple(
                                        ...
                                        tabs: [
                                          Tab(
                                              text: LocaleKeys.title_description
                                                  .tr()),
                                          Tab(
                                              text:
                                                  LocaleKeys.title_review.tr()),
                                        ],
                                      ),
                                      Container(
